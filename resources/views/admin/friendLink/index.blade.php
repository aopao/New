          ...
          <div class="layui-card-body">
            ...
            <table class="layui-hide" id="categorList" lay-filter="categorList"></table>
			  ...
			  <script type="text/html" id="contentTpl">
				  @{{#  if(d.type == 1){ }}
				  @verbatim{{d.title}}@endverbatim
				  @{{#  } else { }}
				  	@verbatim<div><img src="{{d.pic}}" onerror="this.src='/errorimg/error.jpg'"></div>@endverbatim',style:'height:48px;width:48px;line-height:48px!important;'}
				  @{{#  } }}
			  </script>
