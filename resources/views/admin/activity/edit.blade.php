            ...
            <div class="layui-form layui-form-pane">
                <div class="layui-card" style="height: 1500px;">
                    <div class="layui-card-header">
                        ...
                        @lang('activity.activity_edit')
                    </div>
                    <div class="layui-card-body" pad15="2">
                        <div class="layui-tab layui-tab-brief" lay-filter="user">
                            <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
                                <div class="layui-tab-item layui-show">
                                    <form class="layui-form layui-form-pane" action="{{ route('admin.activity.update',['id'=>$activity_info['id']]) }}" method="post">

                                        <div class="layui-form-item">
                                            <label class="layui-form-label" for="Title">@lang('activity.title')</label>
                                            <div class="layui-input-block">
                                                <input type="text" id="Title" name="title" value="{{ $activity_info['title'] }}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" id="SubTitle" name="subtitle" value="{{ $activity_info['subtitle'] }}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" id="desc" name="desc" value="{{ $activity_info['desc'] }}"  required="" lay-verify="required" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" class="layui-input" name="range" id="range" placeholder=" - " value="{{ $activity_info['range'] }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" id="method" name="method" value="{{ $activity_info['method'] }}"  required="" lay-verify="required" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" id="obj" name="obj" value="{{ $activity_info['obj'] }}"  required="" lay-verify="required" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item" pane="">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                @else
                                                    <input type="radio" name="status" value="1" title="@lang('activity.status_on')" >
                                                    <input type="radio" name="status" value="0" title="@lang('activity.status_off')" checked="">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <button class="layui-btn layui-btn-normal" style="margin-top: 15px;" lay-submit=""><i class="layui-icon">&#xe609;</i> @lang('activity.edit_submit')</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        layui.config({
            ...
            ue.ready(function () {
                ...
                ue.setContent("{!! $activity_info['content'] !!}");
            });
