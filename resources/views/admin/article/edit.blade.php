            ...
            <div class="layui-form layui-form-pane">
                <div class="layui-card" style="height: 1500px;">
                    <div class="layui-card-header">
                        <a class="layui-btn layui-btn-normal layui-btn-radius layui-btn-sm" href="{{ route('admin.article.update',['id'=>$article_info['id']]) }}">@lang('article.article_edit')</a>
                        ...
                        <div class="layui-tab layui-tab-brief" lay-filter="user">
                            <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
                                <div class="layui-tab-item layui-show">
                                    <form class="layui-form layui-form-pane" action="{{ route('admin.article.store') }}" method="post">
                                        
                                        <div class="layui-form-item">
                                            <label class="layui-form-label" for="CategoryId">@lang('article.category_id')</label>
                                            <div class="layui-input-inline">
                                                @inject("CategoryList","\App\Presenters\CategoryListPresenter")
                                                <select name="category_id" id="CategoryId" lay-verify="required">
                                                    <option value="0" disabled="disabled">@lang('article.category')</option>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" id="Title" name="title" required="" lay-verify="required" autocomplete="off" value="{{ $article_info['title'] }}" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item" pane="">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="radio" name="is_http_url" lay-filter="is_http_url" value="0" title="@lang('article.is_http_url.no')" checked="">
                                                <input type="radio" name="is_http_url" value="1" lay-filter="is_http_url" title="@lang('article.is_http_url.yes')">
                                            </div>
                                        </div>
                                        
                                        <div class="layui-form-item" id="HttpUrl" style="display: none;">
                                            <label class="layui-form-label" for="HttpUrl">@lang('article.http_url')</label>
                                            <div class="layui-input-block">
                                                <input type="text" id="HttpUrl" name="http_url" autocomplete="off" class="layui-input" placeholder="@lang('article.is_http_url_tips')">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item layui-form-text" id="excerpt">
                                            ...
                                            <div class="layui-input-block">
                                                <textarea placeholder="@lang('article.excerpt')" name="excerpt" class="layui-textarea">{{ $article_info['excerpt'] }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item" pane="">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="radio" name="is_top" value="0" title="@lang('article.is_top.no')" checked="">
                                                <input type="radio" name="is_top" value="1" title="@lang('article.is_top.single')">
                                                <input type="radio" name="is_top" value="2" title="@lang('article.is_top.global')">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item" pane="">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="radio" name="is_remark" value="0" title="@lang('article.is_remark.no')" checked="">
                                                <input type="radio" name="is_remark" value="1" title="@lang('article.is_remark.yes')">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item" pane="">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="radio" name="status" value="0" title="@lang('article.status.publish')" checked="">
                                                <input type="radio" name="status" value="1" title="@lang('article.status.draft')">
                                            </div>
                                        </div>
                                        
                                        {{ csrf_field() }}
                                        <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                                        <button class="layui-btn layui-btn-normal" style="margin-top: 15px;" lay-submit="">
                                            <i class="layui-icon">&#xe609;</i> @lang('article.article_add')
                                        </button>
