                                ...
                                <div class="layui-tab-item layui-show">
                                    <form class="layui-form layui-form-pane" action="{{ route('admin.article.store') }}" method="post">
                                        ...
                                        <div class="layui-form-item layui-form-text" id="excerpt">
                                            ...
                                            <div class="layui-input-block">
                                                <textarea placeholder="@lang('article.excerpt')" name="excerpt" class="layui-textarea"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <button class="layui-btn layui-btn-normal" style="margin-top: 15px;" lay-submit=""><i class="layui-icon">&#xe609;</i> @lang('article.article_add')</button>
                                    </form>
                                </div>
                            </div>
                        </div>
