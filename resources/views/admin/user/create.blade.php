    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">@lang('user.user_add')</div>
                <div class="layui-card-body" pad15="2">
                    <form action="{{ route('admin.user.store') }}" method="post" class="layui-form layui-form-pane">
                        <div class="layui-form-item" id="pic"  >
                            <label class="layui-form-label" for="Thumb">@lang('user.avatar')</label>
                            <div class="layui-input-inline">
                                <input lay-verify="type" type="text" id="PicUrl" name="avatar" value="{{ old('avatar') }}" autocomplete="off" class="layui-input"/>
                            </div>
                            ...
                            <div id="PicHtml" style="display: none">
                                <img src="{{ old('avatar') }}" id="PicHtmlUrl" alt="">
                            </div>
                        ...
                        <div class="layui-form-item" id="title">
                            ...
                            <div class="layui-input-block">
                                <input   autocomplete="off" class="layui-input"  name="account" value="{{ old('account') }}" placeholder="@lang('user.account')" type="text"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">@lang('user.nickname')</label>
                            <div class="layui-input-block">
                                <input  autocomplete="off" class="layui-input" name="nickname" value="{{ old('nickname') }}" placeholder="@lang('user.nickname')" type="text"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">@lang('user.mobile')</label>
                            <div class="layui-input-block">
                                <input  autocomplete="off" class="layui-input" name="mobile" value="{{ old('mobile') }}" placeholder="@lang('user.mobile')" type="text"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">@lang('user.email')</label>
                            <div class="layui-input-block">
                                <input  autocomplete="off" class="layui-input" name="email" value="{{ old('email') }}" placeholder="@lang('user.email')" type="text"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">@lang('user.qq')</label>
                            <div class="layui-input-block">
                                <input  autocomplete="off" class="layui-input" name="qq" value="{{ old('qq') }}" placeholder="@lang('user.qq')" type="text"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item" style="text-align: center">
                            {{ csrf_field() }}
                            <button class="layui-btn layui-btn-normal" lay-submit=""><i class="layui-icon">&#xe609;</i> @lang('user.add_submit')</button>
                        </div>
                    </form>
                </div>
            </div>
